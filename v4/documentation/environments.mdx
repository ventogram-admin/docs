...
- **Mock endpoints available.** Use [Mock Deposit](/api-reference/mock/mock-deposit) and [Mock Fiat Deposit](/api-reference/mock/mock-fiat-deposit) to simulate incoming payments and test your webhook handling.
