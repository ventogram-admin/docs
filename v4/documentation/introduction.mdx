...
**Offramp**: Your users send crypto. They receive local currency in their bank account or mobile money wallet. Partna handles the conversion and payout automatically.
...
You can retrieve the list of supported assets, by network and by currency, for each environment via the following endpoints:
- Staging Supported Assets: https://staging-api.getpartna.com/v4/supported/assets
- Production Supported Assets: https://api.getpartna.com/v4/supported/assets
